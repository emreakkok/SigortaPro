...
// yanında Persistence katmanında tutulur; implementasyonu Persistence'tadır.
public interface IRefreshTokenService
{
    ...
    // Bir kullanıcının tüm aktif refresh token'larını iptal eder. Personel pasifleştirildiğinde
