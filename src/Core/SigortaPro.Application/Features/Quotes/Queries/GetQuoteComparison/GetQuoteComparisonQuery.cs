...
// InsuredBirthDate: Sağlıkta "başkası adına" önizlemede sigortalının doğum tarihi; null = poliçe sahibi.
// IsSmoker: Sağlıkta sigara BEYANI — teklif oluşturmadaki kuralın aynısı (zorunlu).
//
// Önizleme, fiyatlama girdisini teklif oluşturmayla AYNI builder'dan kurar; bu yüzden burada
