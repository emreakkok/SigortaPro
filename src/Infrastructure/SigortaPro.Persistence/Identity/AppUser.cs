...
// Kimlik kullanıcısı Domain'in dışında, Persistence katmanında tanımlanır.
...
{
    // Hesap yaşam döngüsü. Pasif hesap giriş yapamaz ve token yenileyemez (login/refresh reddi).
    // Migration additive'dir; mevcut satırlar DEFAULT 1 (aktif) alır → geriye dönük erişim korunur.
    public bool IsActive { get; set; } = true;

    // Personel/Admin hesaplarının görünen adı. Customer profili olmayan kimlik hesapları için
